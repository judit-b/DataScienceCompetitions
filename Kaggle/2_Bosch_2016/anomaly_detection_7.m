...
load('anomaly_cluster_assignments.mat', 'obsToCluster');
num_obs = 0;
for i = 1 : 6
...
save('anomaly_cluster_assignments.mat', 'allObsToCluster', '-append');
...
%cluster_76_70 = cell(5, 1);
%cluster_81_85 = cell(5, 1);
%cluster_86_80 = cell(5, 1);
%cluster_91_95 = cell(5, 1);
%cluster_96_100 = cell(5, 1);

save('anomaly_clusters_train.mat', 'cluster_1_5');
save('anomaly_clusters_train.mat', 'cluster_6_10', '-append');
save('anomaly_clusters_train.mat', 'cluster_11_15', '-append');
save('anomaly_clusters_train.mat', 'cluster_16_20', '-append');
save('anomaly_clusters_train.mat', 'cluster_21_25', '-append');
save('anomaly_clusters_train.mat', 'cluster_26_30', '-append');
save('anomaly_clusters_train.mat', 'cluster_31_35', '-append');
save('anomaly_clusters_train.mat', 'cluster_36_40', '-append');
%save('anomaly_clusters_train.mat', 'cluster_41_45', '-append');
%save('anomaly_clusters_train.mat', 'cluster_46_50', '-append');
%save('anomaly_clusters_train.mat', 'cluster_51_55', '-append');
%save('anomaly_clusters_train.mat', 'cluster_56_60', '-append');
%save('anomaly_clusters_train.mat', 'cluster_61_65', '-append');
%save('anomaly_clusters_train.mat', 'cluster_66_70', '-append');
%save('anomaly_clusters_train.mat', 'cluster_71_75', '-append');
%save('anomaly_clusters_train.mat', 'cluster_76_80', '-append');
%save('anomaly_clusters_train.mat', 'cluster_81_85', '-append');
%save('anomaly_clusters_train.mat', 'cluster_86_90', '-append');
%save('anomaly_clusters_train.mat', 'cluster_91_95', '-append');
%save('anomaly_clusters_train.mat', 'cluster_96_100', '-append');

load('anomaly_clusters_train.mat', 'cluster_1_5');
for i = 1 : 5
    cluster_1_5{i, 1} = zeros(size(allObsToCluster(allObsToCluster(:,2)==i, :), 1), 970);
end;
save('anomaly_clusters_train.mat', 'cluster_1_5', '-append');
...
% 
% load('anomaly_clusters_train.mat', 'cluster_56_60');
% cluster_56_60 = FindAndStoreFiveClusterData(dataset_numeric_2, cluster_56_60, 6, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_56_60', '-append');
% clearvars cluster_56_60;

% load('anomaly_clusters_train.mat', 'cluster_61_65');
% cluster_61_65 = FindAndStoreFiveClusterData(dataset_numeric_2, cluster_61_65, 1, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_61_65', '-append');
% clearvars cluster_61_65;
% 
% load('anomaly_clusters_train.mat', 'cluster_66_70');
...
% 
% load('anomaly_clusters_train.mat', 'cluster_56_60');
% cluster_56_60 = FindAndStoreFiveClusterData(dataset_numeric_3, cluster_56_60, 6, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_56_60', '-append');
% clearvars cluster_56_60;

% load('anomaly_clusters_train.mat', 'cluster_61_65');
% cluster_61_65 = FindAndStoreFiveClusterData(dataset_numeric_3, cluster_61_65, 1, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_61_65', '-append');
% clearvars cluster_61_65;
% 
% load('anomaly_clusters_train.mat', 'cluster_66_70');
...
% 
% load('anomaly_clusters_train.mat', 'cluster_56_60');
% cluster_56_60 = FindAndStoreFiveClusterData(dataset_numeric_4, cluster_56_60, 6, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_56_60', '-append');
% clearvars cluster_56_60;

% load('anomaly_clusters_train.mat', 'cluster_61_65');
% cluster_61_65 = FindAndStoreFiveClusterData(dataset_numeric_4, cluster_61_65, 1, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_61_65', '-append');
% clearvars cluster_61_65;
% 
% load('anomaly_clusters_train.mat', 'cluster_66_70');
...
% 
% load('anomaly_clusters_train.mat', 'cluster_56_60');
% cluster_56_60 = FindAndStoreFiveClusterData(dataset_numeric_5, cluster_56_60, 6, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_56_60', '-append');
% clearvars cluster_56_60;

% load('anomaly_clusters_train.mat', 'cluster_61_65');
% cluster_61_65 = FindAndStoreFiveClusterData(dataset_numeric_5, cluster_61_65, 1, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_61_65', '-append');
% clearvars cluster_61_65;
% 
% load('anomaly_clusters_train.mat', 'cluster_66_70');
...
% 
% load('anomaly_clusters_train.mat', 'cluster_56_60');
% cluster_56_60 = FindAndStoreFiveClusterData(dataset_numeric_6, cluster_56_60, 6, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_56_60', '-append');
% clearvars cluster_56_60;

% load('anomaly_clusters_train.mat', 'cluster_61_65');
% cluster_61_65 = FindAndStoreFiveClusterData(dataset_numeric_6, cluster_61_65, 1, allObsToCluster);
% save('anomaly_clusters_train.mat', 'cluster_61_65', '-append');
% clearvars cluster_61_65;
% 
% load('anomaly_clusters_train.mat', 'cluster_66_70');
...
toc            % Elapsed time is 186.834358 seconds.