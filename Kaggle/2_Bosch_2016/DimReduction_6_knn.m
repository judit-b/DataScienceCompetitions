...
rng(1234);
tic
load('clusters_with_rel_feats_knn.mat', 'final_clusters');
all_balanced_clusters = cell(40, 1);
...
toc      % Elapsed time is 34846.842054 seconds.

save('anomaly_balanced_clusters_knn.mat', 'all_balanced_clusters');