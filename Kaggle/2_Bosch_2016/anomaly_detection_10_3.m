...
save('anomaly_clusters_with_rel_feats_withoutfreq.mat', 'imputed_clusters_for_anomaly_1', '-append');
...
save('anomaly_clusters_with_rel_feats_withoutfreq.mat', 'imputed_clusters_for_anomaly_2', '-append');
save('anomaly_clusters_with_rel_feats_withoutfreq.mat', 'all_train_cluster_modes_for_anomaly', '-append');
