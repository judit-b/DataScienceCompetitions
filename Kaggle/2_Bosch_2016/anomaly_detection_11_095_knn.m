...
load('anomaly_clusters_with_rel_feats_withoutfreq_095_knn.mat', 'imputed_clusters_for_anomaly_1');
load('anomaly_clusters_with_rel_feats_withoutfreq_095_knn.mat', 'imputed_clusters_for_anomaly_2')
num_clusters = 100;
...
save('anomaly_clusters_with_rel_feats_withoutfreq_095_knn.mat', 'best_feature_transformations', '-append');
save('anomaly_sym_clusters_095_knn.mat', 'all_sym_clusters_1');
save('anomaly_sym_clusters_095_knn.mat', 'all_sym_clusters_2', '-append');
