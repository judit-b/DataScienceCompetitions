tic
load('anomaly_sym_clusters_095_knn.mat');    % training set
cellarray1=all_sym_clusters_1;
cellarray2=all_sym_clusters_2;
load('anomaly_final_valid_set_095_knn.mat');        % validation set
valdata=anomaly_final_valid_clusters;
load('anomaly_final_test_set_095_knn.mat');        % test set
testdata=anomaly_final_test_clusters;
Y_fit=[];
Y=[];
sigmadiag=[];
rng(210);
...
save('anomaly_models_095.mat', 'models'); 
save('anomaly_models_095.mat', 'tresholds', '-append');

toc         % Elapsed time is 20336.301140 seconds.
