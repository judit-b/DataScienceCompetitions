function obsToCluster = AssignObservationsToCluster2(dataset, ids_to_take, centroids, frequent_features)
...
for obs_idx = 1 : num_obs
    ...
    obs_01_repr = (obs_01_repr - frequent_features > 0);   % only nonfrequent features matter
    obs_01_repr = double(obs_01_repr);
